    ...
    return (
        <button
            ...
            className={cn(
                ...
                // before styles
                "before:absolute before:bottom-[-20%] before:left-1/2 before:z-0 before:h-1/5 before:w-3/5 before:-translate-x-1/2 before:[animation:rainbow_5s_infinite_linear] before:bg-[linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-2)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-5)))] before:bg-[length:200%] before:[filter:blur(calc(0.8*1rem))]",
                // bg styles
