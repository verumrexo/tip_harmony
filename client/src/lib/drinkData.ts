...
export const drinkCategories: DrinkCategory[] = [
    {
        ...
        items: [
            { name: "b/g Mangaļi 0.33l", subsection: "Ūdens" },
            { name: "a/g Mangaļi 0.33l", subsection: "Ūdens" },
            { name: "b/g Acqua Panna 0.25l", subsection: "Ūdens" },
            { name: "b/g Acqua Panna 0.75l", subsection: "Ūdens" },
            { name: "a/g S.Pellegrino 0.25l", subsection: "Ūdens" },
            { name: "a/g S.Pellegrino 0.75l", subsection: "Ūdens" },
            { name: "Pepsi Cola", subsection: "Cido" },
            { name: "Mirinda", subsection: "Cido" },
            { name: "7Up", subsection: "Cido" },
            { name: "Indian", subsection: "Toniks" },
            { name: "Mediterranean", subsection: "Toniks" },
            { name: "Aromatic", subsection: "Toniks" },
            { name: "Ginger Ale", subsection: "Toniks" },
            { name: "Rose", subsection: "Fentimans" },
            { name: "Cherry Cola", subsection: "Fentimans" },
            { name: "Mandarin Orange Jigger", subsection: "Fentimans" },
            { name: "Kvass 0.5", subsection: "Kvass" },
            { name: "Kvass 0.3", subsection: "Kvass" },
    ...
    },
    {
        ...
        items: [
            { name: "Espreso", subsection: "Kafijas" },
            { name: "Makiato", subsection: "Kafijas" },
            { name: "Dubultais espresso", subsection: "Kafijas" },
            { name: "Kafija melna", subsection: "Kafijas" },
            { name: "Kafija balta", subsection: "Kafijas" },
            { name: "Latte", subsection: "Kafijas" },
            { name: "Latte Dubultais", subsection: "Kafijas" },
            { name: "Cappucino", subsection: "Kafijas" },
            { name: "Cappucino dubultais", subsection: "Kafijas" },
            { name: "Kakao", subsection: "Kafijas" },
            { name: "Melnā tēja", subsection: "Tējas" },
            { name: "Zaļā tēja", subsection: "Tējas" },
            { name: "Augļu tēja", subsection: "Tējas" },
            { name: "Piparmētru tēja", subsection: "Tējas" },
            { name: "Grenadīntēja", subsection: "Tējas" },
        ],
    },
    {
        name: "KOKTEIĻI",
